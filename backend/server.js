...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL, // Usamos la URL completa de Render
  ssl: { // <-- CORREGIDO: SOLO 'ca' (sin rejectUnauthorized: false)
    ca: process.env.PG_CA // Usamos el certificado CA de Render
  }
});
